...
namespace DefaultNamespace
{
    public class InitialScene : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                string text = "{\"id\":529,\"imageUrl\":\"https://p4.taihuoniao.com/scene_rendering/user_fodder/220517/628347579b25fefdacc58287\",\"name\":\"showcase-011\",\"location\":[0,0,0],\"scaleS\":1,\"rotateS\":0,\"isDel\":false,\"nKind\":2,\"cloneBase\":\"\"}";
                FindObjectOfType<JsSend>().JsUpdateTrans(text);
            }
