...
namespace DefaultNamespace
{
    public class JsonData
    {
        ...
        {
            public string name;
            public string qiniu_path_url; // ÆßÅ£ ¸ùÄ¿Â¼
            public string fbx_file_url; // fbx url
            public string fbx_name; // fbx 
            public string ab_name; // ³¡¾°ab°ü
        }
        
        [Serializable]
        public class ArtData
        {
            public string name; // »­¿òÃû×Ö
            public string imageUrl; // »­¿òÍ¼Æ¬Ãû
            public float[] scale; // »­¿òËõ·ÅÖµ
            public float[] rotate; // »­¿òÐý×ªÖµ
            public float[] position; // »­¿ò×ø±êÖµ
        }
