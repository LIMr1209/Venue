...
namespace DefaultNamespace
{
    public class Globle : MonoBehaviour
    {
        ...
        public static string worksListRoute = "/api/room/works_list"; // 作品列表  urlId 2
        public static string roomViewRoute = "/api/room/view"; // 房间详情  urlId 3
        public static string roomMemberListRoute = "/api/room_member/list"; // 房间成员 urlId 4
